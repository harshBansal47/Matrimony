...
import placeholderImage from "@/public/blog.webp";
  ...
  const blogData: Blog[] = [
    {
      ...
      excerpt: "Discover how AI is revolutionizing the matchmaking industry by providing personalized and accurate partner suggestions.",
    ...
    },
    {
      ...
      excerpt: "AI is shaping the future of dating apps by enhancing user experiences and providing smarter matchmaking solutions.",
    ...
    },
    {
      ...
      excerpt: "Creating a compelling online dating profile is key to finding the right match. Learn how to craft a profile that stands out.",
