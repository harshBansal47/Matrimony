...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 z-50 w-full bg-red-50">
      <div className="py-2 px-10 lg:px-15 flex justify-between items-center">
  ...
  />
      ...
      <div className={`lg:hidden ${expand ? "block" : "hidden"} bg-inherit`}>
        <ul className="flex flex-col gap-4 p-4 justify-center items-center">
          <li>
            <a href="/" className={`text-lg text-[#333333] hover:text-[#bf65ad] ${openSans.className} font-bold text-pink-700`}>
              Home
            </a>
          </li>
          <li>
            <a href="/about" className={`text-lg text-[#333333] hover:text-[#bf65ad] ${openSans.className} font-bold text-pink-700`}>
              About
            </a>
          </li>
          <li>
            <a href="/contact" className={`text-lg text-[#333333] hover:text-[#bf65ad] ${openSans.className} font-bold text-pink-700`}>
              Contact
            </a>
          </li>
          <li>
            <a href="/blogs" className={`text-lg text-[#333333] hover:text-[#bf65ad] ${openSans.className} font-bold text-pink-700`}>
              Blogs
            </a>
          </li>
        </ul>
